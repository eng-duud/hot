    ...
    <header className="fixed top-0 left-0 right-0 z-50 flex flex-col items-center">
      ...
      <div className="w-full bg-gradient-to-b from-black/95 to-[#121212]/90 backdrop-blur-2xl border-b border-white/[0.08] shadow-[0_4px_30px_rgba(0,0,0,0.3)] relative z-10">
        <div className="container mx-auto px-4 md:px-8">
          <div className="flex items-center justify-between h-20 md:h-24 pb-2 md:pb-4 pt-2">
      ...
      <div className="w-full bg-[#121212]/95 backdrop-blur-3xl border-b border-white/[0.04] shadow-[0_10px_30px_rgba(0,0,0,0.3)] z-20">
        <div className="container mx-auto px-0 md:px-8">
          <nav className="flex items-center justify-center md:gap-2 h-16 md:h-16 overflow-x-auto scrollbar-hide px-2">
            {navLinks.map((link) => {
              ...
              return (
                <Link
                  ...
                  href={link.href}
                  className={cn(
                    "flex items-center gap-2 px-4 py-2 md:px-6 md:py-2.5 text-[13px] md:text-base font-bold rounded-full whitespace-nowrap transition-all duration-300 mx-1",
                    isActive 
